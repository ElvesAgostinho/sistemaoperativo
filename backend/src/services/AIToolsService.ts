...
export const aiTools = [
    ...
    },
    {
        ...
        function: {
            ...
            description: "Agenda uma reunião com sala de videochamada privada gerada automaticamente (Jitsi, com ata gerada por IA a partir do áudio da chamada) no módulo de Reuniões da empresa.",
            parameters: {
                type: "object",
                properties: {
